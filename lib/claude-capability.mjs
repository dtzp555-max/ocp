...
//
// THE PROBLEM THIS SOLVES (past tense on purpose -- this file is the fix). OCP spawns `claude` on
// every request and had no version or capability gate for it.
...
export function capabilityBootError({ flag, bin }) {
  return (
    ...
    `  to boot anyway and accept that failure mode.\n` +
    `  See README § Troubleshooting and https://github.com/dtzp555-max/ocp/issues/455.`
  );
}
