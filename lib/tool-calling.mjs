...
//   * MCP tools are DEFERRED in the CLI's schema, so the first call in a turn is preceded by a
//     `ToolSearch` turn that resolves the name. One extra model round-trip per tool turn; noted,
//     not fixed here.
