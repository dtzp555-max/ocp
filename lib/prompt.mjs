...
//
// This does NOT expand the tool surface: tools are governed by `--tools` (which built-in tools
// EXIST for the session) and `--allowedTools` / `--disallowedTools` (which of them may run without
// a prompt) -- never by the wrapper, which only changes the PROMPT the operator's own model reads.
