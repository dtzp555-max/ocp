...
export function buildTuiCmd(claudeBin, model, sessionId, ehome, entrypointMode, stream = null) {
  ...
  if (process.env.OCP_TUI_FULL_TOOLS === "1") {
    ...
    // brick the pane). Value is passed through verbatim (comma-separated names, e.g.
    // "Read,Glob,Grep,WebSearch,WebFetch"; "" disables all, "default" enables all — verbatim
    // from `claude --help`, verified on 2.1.220). Unset or empty => today's behaviour: all
