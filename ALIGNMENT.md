...
- **Claude Code version under audit:** `<to be filled by annual audit>`
- **`cli.js` SHA-256:** `<to be filled by annual audit>`
- **Audit date:** `<to be filled by annual audit>`
- **Auditor:** `<to be filled by annual audit>`
