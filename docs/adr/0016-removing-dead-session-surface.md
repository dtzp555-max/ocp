...
>
> *(This paragraph is itself a correction. As first drafted it said the quote "stops at *The array is unreachable, not under-probed*" and that "the very next sentence" named the fields — a stopping point this ADR never had, asserted in a paragraph diagnosing an unverified quotation, and caught by independent review. The conclusion was unchanged; the mechanism was understated. Recorded rather than silently reworded, because a near-miss and a mid-clause cut are different lessons.)*
>
